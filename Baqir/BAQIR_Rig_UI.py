...
class BLOP_PT_riguilayers(bpy.types.Panel):
	...
	def draw(self, context):
		...
		row = col.row()
		row.prop(context.active_object.data,'layers', index=12, toggle=True, text='FACE')
		row.prop(context.active_object.data,'layers', index=13, toggle=True, text='FACE-TWEAK')

		row = col.row()
		row.prop(context.active_object.data,'layers', index=16, toggle=True, text='LEG FK.L')
		row.prop(context.active_object.data,'layers', index=18, toggle=True, text='LEG FK.R')
		...
		row = col.row()
		row.prop(context.active_object.data,'layers', index=20, toggle=True, text='ARM FK.L')
		row.prop(context.active_object.data,'layers', index=22, toggle=True, text='ARM FK.R')

		row = col.row()
		row.prop(context.active_object.data,'layers', index=21, toggle=True, text='ARM IK.L')
		row.prop(context.active_object.data,'layers', index=23, toggle=True, text='ARM IK.R')

		row = col.row()
		row.prop(context.active_object.data,'layers', index=11, toggle=True, text='EQUIPMENT')

		row = col.row()
		row.prop(context.active_object.data,'layers', index=10, toggle=True, text='TAIL')
